...
#include "dclaw_interfaces/srv/detail/set_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dclaw_interfaces::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dclaw_interfaces::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  return &dclaw_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const dclaw_interfaces::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dclaw_interfaces::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dclaw_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions_Response__handle;
}
...
{
  return &dclaw_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions__handle;
}
