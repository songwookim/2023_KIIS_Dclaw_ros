...
#include <stddef.h>
#include "dclaw_interfaces/msg/detail/set_position__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dclaw_interfaces__msg__SetPosition__init(message_memory);
}

void SetPosition__rosidl_typesupport_introspection_c__SetPosition_fini_function(void * message_memory)
{
  dclaw_interfaces__msg__SetPosition__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetPosition__rosidl_typesupport_introspection_c__SetPosition_message_member_array[2] = {
  {
    ...
    offsetof(dclaw_interfaces__msg__SetPosition, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dclaw_interfaces__msg__SetPosition, position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPosition__rosidl_typesupport_introspection_c__SetPosition_message_members = {
  "dclaw_interfaces__msg",  // message namespace
  "SetPosition",  // message name
  2,  // number of fields
  sizeof(dclaw_interfaces__msg__SetPosition),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dclaw_interfaces, msg, SetPosition)() {
