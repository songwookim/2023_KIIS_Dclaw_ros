...
from dclaw_interfaces.srv import *
from dclaw_interfaces.msg import *
...
def read_write_py_node():
    rclpy.init_node('read_write_py_node')
    rclpy.Subscriber('set_position', SetPosition, set_goal_pos_callback)
    rclpy.Service('get_position', GetPosition, get_present_pos)
    rclpy.spin()
