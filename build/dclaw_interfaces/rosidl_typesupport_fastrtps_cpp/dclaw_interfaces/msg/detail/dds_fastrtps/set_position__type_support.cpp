...
#include "dclaw_interfaces/msg/detail/set_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dclaw_interfaces::msg::SetPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dclaw_interfaces::msg::SetPosition *>(
    untyped_ros_message);
...
{
  return &dclaw_interfaces::msg::typesupport_fastrtps_cpp::_SetPosition__handle;
}
