    ...
    def position(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'position' field must be an unsigned integer in [0, 4294967295]"
...
class Metaclass_GetPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dclaw_interfaces.srv.GetPositions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dclaw_interfaces.srv import _get_positions
...
class GetPositions(metaclass=Metaclass_GetPositions):
    from dclaw_interfaces.srv._get_positions import GetPositions_Request as Request
    from dclaw_interfaces.srv._get_positions import GetPositions_Response as Response
