...
#ifndef DCLAW_INTERFACES__SRV__DETAIL__SET_POSITION__FUNCTIONS_H_
#define DCLAW_INTERFACES__SRV__DETAIL__SET_POSITION__FUNCTIONS_H_
 ...
 * calls
 * dclaw_interfaces__srv__SetPosition_Request__init().
...
/**
 * It calls
 * dclaw_interfaces__srv__SetPosition_Request__fini()
 ...
 * dclaw_interfaces__srv__SetPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dclaw_interfaces__srv__SetPosition_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dclaw_interfaces__srv__SetPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dclaw_interfaces
...
/**
 * It calls
 * dclaw_interfaces__srv__SetPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dclaw_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dclaw_interfaces__srv__SetPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dclaw_interfaces
...
/**
 * It calls
 * dclaw_interfaces__srv__SetPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DCLAW_INTERFACES__SRV__DETAIL__SET_POSITION__FUNCTIONS_H_
