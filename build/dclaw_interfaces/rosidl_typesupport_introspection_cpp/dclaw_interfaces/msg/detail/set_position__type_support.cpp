...
{
  new (message_memory) dclaw_interfaces::msg::SetPosition(_init);
}

void SetPosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dclaw_interfaces::msg::SetPosition *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPosition_message_member_array[2] = {
  {
    ...
    offsetof(dclaw_interfaces::msg::SetPosition, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dclaw_interfaces::msg::SetPosition, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPosition_message_members = {
  "dclaw_interfaces::msg",  // message namespace
  "SetPosition",  // message name
  2,  // number of fields
  sizeof(dclaw_interfaces::msg::SetPosition),
...
get_message_type_support_handle<dclaw_interfaces::msg::SetPosition>()
{
  return &::dclaw_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dclaw_interfaces, msg, SetPosition)() {
  return &::dclaw_interfaces::msg::rosidl_typesupport_introspection_cpp::SetPosition_message_type_support_handle;
}
