...
static const _SetPositions_Request_type_support_symbol_names_t _SetPositions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dclaw_interfaces, srv, SetPositions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dclaw_interfaces, srv, SetPositions_Request)() {
  return &::dclaw_interfaces::srv::rosidl_typesupport_c::SetPositions_Request_message_type_support_handle;
}
...
static const _SetPositions_Response_type_support_symbol_names_t _SetPositions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dclaw_interfaces, srv, SetPositions_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dclaw_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dclaw_interfaces, srv, SetPositions_Response)() {
  return &::dclaw_interfaces::srv::rosidl_typesupport_c::SetPositions_Response_message_type_support_handle;
}
...
static const _SetPositions_type_support_symbol_names_t _SetPositions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dclaw_interfaces, srv, SetPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dclaw_interfaces, srv, SetPositions)() {
  return &::dclaw_interfaces::srv::rosidl_typesupport_c::SetPositions_service_type_support_handle;
}
