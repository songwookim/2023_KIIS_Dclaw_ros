...
class Metaclass_SetPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dclaw_interfaces.srv.SetPositions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dclaw_interfaces.srv import _set_positions
...
class SetPositions(metaclass=Metaclass_SetPositions):
    from dclaw_interfaces.srv._set_positions import SetPositions_Request as Request
    from dclaw_interfaces.srv._set_positions import SetPositions_Response as Response
