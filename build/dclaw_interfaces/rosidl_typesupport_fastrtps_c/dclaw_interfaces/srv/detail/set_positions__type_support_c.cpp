...
#include "dclaw_interfaces/srv/detail/set_positions__rosidl_typesupport_fastrtps_c.h"
...
using _SetPositions_Request__ros_msg_type = dclaw_interfaces__srv__SetPositions_Request;
...
size_t get_serialized_size_dclaw_interfaces__srv__SetPositions_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetPositions_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dclaw_interfaces__srv__SetPositions_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dclaw_interfaces
size_t max_serialized_size_dclaw_interfaces__srv__SetPositions_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dclaw_interfaces__srv__SetPositions_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions_Request)() {
...
using _SetPositions_Response__ros_msg_type = dclaw_interfaces__srv__SetPositions_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dclaw_interfaces
size_t get_serialized_size_dclaw_interfaces__srv__SetPositions_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPositions_Response__ros_msg_type * ros_message = static_cast<const _SetPositions_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dclaw_interfaces__srv__SetPositions_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dclaw_interfaces
size_t max_serialized_size_dclaw_interfaces__srv__SetPositions_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dclaw_interfaces__srv__SetPositions_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions_Response)() {
...
// already included above
// #include "dclaw_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dclaw_interfaces/srv/set_positions.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dclaw_interfaces, srv, SetPositions)() {
